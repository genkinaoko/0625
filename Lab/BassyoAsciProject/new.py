...
ttfontname = "C:\Windows\Fonts\arial.ttf"
fontsize = 36
#text = "TakasAKiGHenki"

text2 = open(r'C:\genkinaoko\Desktop-another\git\0625\Mac\result\out3.txt', 'r')
data = text2.read()
...
img.save(r"C:\genkinaoko\Desktop-another\git\0625\Lab\result\out.jpg")
text2.close()